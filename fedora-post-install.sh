...
# Personal stuff
sudo dnf install dconf-editor neovim util-linux-user gnome-shell-extension-appindicator gnome-shell-extension-just-perfection gnome-shell-extension-gsconnect gnome-shell-extension-blur-my-shell gnome-shell-extension-user-theme gnome-tweaks ffmpegthumbnailer yt-dlp steam discord vlc evolution adw-gtk3-theme soundconverter papirus-icon-theme zsh -y
