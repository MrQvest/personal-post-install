...
# Essentials
sudo dnf install strawberry torbrowser-launcher steam adw-gtk3-theme yt-dlp zsh zsh-autosuggestions zsh-syntax-highlighting gh papirus-icon-theme zoxide -y
